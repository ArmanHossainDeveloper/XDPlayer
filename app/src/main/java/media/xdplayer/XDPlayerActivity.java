...
public class XDPlayerActivity extends BaseActivity {
    ...
    XDMediaController mediaController;
    ...
    private void initialize() {
        ...
        mediaController = new XDMediaController(this, videoView, gestureManipulator, playbackUpdate, getScreenWidth());
    }
