...
public class MediaController2 {
    ...
    public MediaController2(Activity context, VideoView videoView, MediaPlaybackUpdate playbackUpdate, int screenWidth) {
        activity = context;
    ...
    public void setMediaListener(){
        ...
        videoView.setOnCompletionListener(mp -> setIsPlaying(false));
...
/*    public void jumpSeek(int progress){
    ...
    int getCurrentPosition(){
        ...
        return videoView.getCurrentPosition();//currentPosition;// / 1000;
    }
