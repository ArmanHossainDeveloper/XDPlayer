...
public class WebmController {
    ...
    public WebmController(Activity context, VideoView videoView, GestureManipulator gestureManipulator, MediaPlaybackUpdate playbackUpdate, int screenWidth/*, int screenHeight*/) {
        activity = context;
